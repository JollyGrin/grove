...
> The open phases and parked ideas, moved out of [TASKS.md](../TASKS.md)
> on 2026-09-05 (grove-275) so the status board stays a small append
> target. Phases mirror DESIGN.md §13 (redrawn 2026-07-03 per design
> review); each phase gets a `docs/plans/` plan (plan-reviewer gated)
> before code. Phase 0 (extraction) shipped 2026-07-04 — its rows are in
> [docs/archive/TASKS-2026-07.md](archive/TASKS-2026-07.md).
